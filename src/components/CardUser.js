        ...
        <Card fluid raised style={{ height: "140px" }}>
          ...
          <Card.Content className="leaderboard-card-content">
            ...
            <div style={{ width: "60%", height: "110px" }}>
              <div className="verticle-divider-leaderboard-left" />
              <Card.Content
                style={{
                  display: "flex",
              ...
              >
                <Card.Header className="ui header" style={{ fontSize: 25 }}>
                  {user.name}
                </Card.Header>
                <div
                  style={{
                ...
                >
                  <p style={{ textAlign: "left", flex: "90%" }}>
                    Answered Questions
                  </p>
                  <p style={{ textAlign: "right", flex: "10%" }}>
              ...
              <div className="verticle-divider-leaderboard-right" />
            </div>
            <div style={{ width: "20%" }}>
